...
namespace MVC.Controllers
{
    public class Data
    {
        ...
        {
            new Student{Id = 101, Name = "Rita Shrestha", Section = "A"},

            new Student{Id = 102, Name = "Deepa Pariyar", Section = "A"},

            new Student{Id = 103, Name = "Raj Shrestha", Section = "B"},
                             
            new Student{Id = 104, Name = "Bimal Kafle", Section = "B"},
                             
            new Student{Id = 105, Name = "Tika Rai", Section = "B"},
       };
